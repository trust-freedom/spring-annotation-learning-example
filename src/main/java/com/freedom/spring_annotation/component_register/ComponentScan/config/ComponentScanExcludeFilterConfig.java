...
@ComponentScan(value = "com.freedom.spring_annotation.component_register.ComponentScan",
               excludeFilters = {
                   ...
                   @Filter(type=FilterType.ASSIGNABLE_TYPE, classes={ComponentScanConfig.class}),
                   @Filter(type=FilterType.ASSIGNABLE_TYPE, classes={ComponentScanIncludeFilterConfig.class}),
                   @Filter(type=FilterType.ASSIGNABLE_TYPE, classes={ComponentScanMyComponentFilterConfig.class})
               })
